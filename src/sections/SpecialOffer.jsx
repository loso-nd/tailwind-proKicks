    ...
    >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <p className="mt-4 lg:max-w-lg info-text">
          Embark on a shopping journey that redefines your experience with unbeatable deals. From prmier selections to incrdible savings, we offer unparalleled value that sets us apart
        </p>
